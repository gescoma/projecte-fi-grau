...
CREATE DATABASE IF NOT EXISTS edelweiss DEFAULT CHARACTER SET 'utf8' DEFAULT COLLATE 'utf8_general_ci';
...
CREATE TABLE campain (
    ...
    responsable VARCHAR(50) NULL,/*MIRAR SI ES PRESCINDIBLE*//*SEGURAMENTE SE ACABARA QUITANDO*/
    cliente VARCHAR(50) NULL, /*MIRAR SI ES PRESCINDIBLE*//*SEGURAMENTE SE ACABARA QUITANDO*/
    PRIMARY KEY (id)
    );
